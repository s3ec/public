Extract the JSCodeZip file. You’ll get a folder. Add it as your plugin by enabling Developer Mode in Extensions
Plugin name --JS Link Reporter
Description
Downloads JS links per site as .txt
